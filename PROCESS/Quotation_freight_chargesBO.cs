...
{
    [Serializable]
    public class Quotation_freight_chargesBO
    {
        ...
        public bool Insert(Quotation_freight_charges Entity)
        {
            try
            {
                Quotation_freight_chargesDO EntityDO = new Quotation_freight_chargesDO();
        ...
        public bool Update(Quotation_freight_charges Entity)
        {
            try
            {
                Quotation_freight_chargesDO EntityDO = new Quotation_freight_chargesDO();
        ...
        public bool Delete(Quotation_freight_charges Entity)
        {
            try
            {
                Quotation_freight_chargesDO EntityDO = new Quotation_freight_chargesDO();
