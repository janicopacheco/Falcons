...
{
    [Serializable]
    public class Quotation_containerBO
    {
        ...
        public bool Insert(Quotation_container Entity)
        {
            try
            {
                Quotation_containerDO EntityDO = new Quotation_containerDO();
        ...
        public bool Update(Quotation_container Entity)
        {
            try
            {
                Quotation_containerDO EntityDO = new Quotation_containerDO();
        ...
        public bool Delete(Quotation_container Entity)
        {
            try
            {
                Quotation_containerDO EntityDO = new Quotation_containerDO();
        ...
        public DataTable SelectByQuotationId(Quotation_container Entity)
        {
            try
            {
                Quotation_containerDO EntityDO = new Quotation_containerDO();
                Success(string.Empty); //or pass success message
                return EntityDO.SelectByQuotationId(Entity);
            }
            catch (Exception ex)
            {
                ExceptionOccurred(ex);
