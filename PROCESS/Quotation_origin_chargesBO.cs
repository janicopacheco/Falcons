...
{
    [Serializable]
    public class Quotation_origin_chargesBO
    {
        ...
        public bool Insert(Quotation_origin_charges Entity)
        {
            try
            {
                Quotation_origin_chargesDO EntityDO = new Quotation_origin_chargesDO();
        ...
        public bool Update(Quotation_origin_charges Entity)
        {
            try
            {
                Quotation_origin_chargesDO EntityDO = new Quotation_origin_chargesDO();
        ...
        public bool Delete(Quotation_origin_charges Entity)
        {
            try
            {
                Quotation_origin_chargesDO EntityDO = new Quotation_origin_chargesDO();
