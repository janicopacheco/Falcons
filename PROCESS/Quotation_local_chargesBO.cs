...
{
    [Serializable]
    public class Quotation_local_chargesBO
    {
        ...
        public bool Insert(Quotation_local_charges Entity)
        {
            try
            {
                Quotation_local_chargesDO EntityDO = new Quotation_local_chargesDO();
        ...
        public bool Update(Quotation_local_charges Entity)
        {
            try
            {
                Quotation_local_chargesDO EntityDO = new Quotation_local_chargesDO();
        ...
        public bool Delete(Quotation_local_charges Entity)
        {
            try
            {
                Quotation_local_chargesDO EntityDO = new Quotation_local_chargesDO();
