<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Site1.Master" AutoEventWireup="true" CodeBehind="Status.aspx.cs" Inherits="Falcon.Secure.Status" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card">
        <h5 class="card-header">Status Table</h5>
        <div class="table-responsive text-nowrap table-height-min">
            ...
            <asp:GridView runat="server"
                ...
                <Columns>
                        ...
                        <ItemTemplate>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="StatusForm.aspx">
                    ...
                    <asp:TemplateField HeaderText="Status Name" SortExpression="name">
                        <ItemTemplate>
