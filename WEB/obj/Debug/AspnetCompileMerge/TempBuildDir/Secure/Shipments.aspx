<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Site1.Master" AutoEventWireup="true" CodeBehind="Shipments.aspx.cs" Inherits="Falcon.Secure.Shipments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card">
        <h5 class="card-header">Shipment Table</h5>
                        ...
                        <ItemTemplate>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="ShipmentsForm.aspx">
