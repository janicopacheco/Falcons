<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Site1.Master" AutoEventWireup="true" CodeBehind="ParticularsForm.aspx.cs" Inherits="Falcon.Secure.ParticularsForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Particular - </span>Add/Edit</h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <small class="text-muted float-end">Create and Update particulars</small>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
