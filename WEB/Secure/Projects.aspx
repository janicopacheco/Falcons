<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Site1.Master" AutoEventWireup="true" CodeBehind="Projects.aspx.cs" Inherits="Falcon.Secure.Projects" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">

        window.onload = function () {
            document.getElementById('master-project').classList.add("active");
        };
    </script>
    <style type="text/css">
        .table {
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalCenterTitle">Search Projects</h5>
                            <button
                                type="button"
                                class="btn-close"
            ...
            <asp:GridView runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Project No." SortExpression="project_no">
                        <ItemTemplate>
                            <asp:Label ID="Labelproject_no" runat="server" Text='<%# Bind("project_no") %>'></asp:Label>
                            <asp:HiddenField runat="server" ID="hdnQuotationId" Value='<%# Bind("quotation_id") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
