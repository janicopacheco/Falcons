<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Site1.Master" AutoEventWireup="true" CodeBehind="ContainersForm.aspx.cs" Inherits="Falcon.Secure.ContainersForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            document.getElementById('manage-container').classList.add("active");
        };
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Container - </span>Add/Edit</h4>
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <small class="text-muted float-end">Create and Update containers</small>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
