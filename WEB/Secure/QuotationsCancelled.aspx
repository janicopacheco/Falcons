<%@ Page Title="" Language="C#" MasterPageFile="~/Secure/Site1.Master" AutoEventWireup="true" CodeBehind="QuotationsCancelled.aspx.cs" Inherits="Falcon.Secure.QuotationsCancelled" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">

        window.onload = function () {
            document.getElementById('master-cancelled').classList.add("active");
        };
    </script>
    <style type="text/css">
        .table {
