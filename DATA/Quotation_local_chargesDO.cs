...
{
    [Serializable]
    public class Quotation_local_chargesDO
    {

        public DataTable SelectAll()
        {
            Database db = DatabaseFactory.CreateDatabase("ApplicationServices");
            String sqlcommand = "[dbo].[quotation_local_charges.SelectAll]";
            DbCommand dbcommand = db.GetStoredProcCommand(sqlcommand);
            return db.ExecuteDataSet(dbcommand).Tables[0];
        }

        public DataTable Select(Quotation_local_charges Entity)
        {
            ...
            Database db = DatabaseFactory.CreateDatabase("ApplicationServices");
            String sqlcommand = "[dbo].[quotation_local_charges.Select]";
            DbCommand dbcommand = db.GetStoredProcCommand(sqlcommand, obj);
            return db.ExecuteDataSet(dbcommand).Tables[0];
        }

        public void Insert(Quotation_local_charges Entity)
        {
            int Result = 0;
            ...
            Database db = DatabaseFactory.CreateDatabase("ApplicationServices");
            String sqlcommand = "[dbo].[quotation_local_charges.Insert]";
            DbCommand dbcommand = db.GetStoredProcCommand(sqlcommand, obj);
        ...
        public void Update(Quotation_local_charges Entity)
        {
            int Result = 0;
            object[] obj = new object[14];
            obj[0] = Entity.Id;
            ...
            obj[13] = Entity.Container_id;
            Database db = DatabaseFactory.CreateDatabase("ApplicationServices");
            String sqlcommand = "[dbo].[quotation_local_charges.Update]";
            DbCommand dbcommand = db.GetStoredProcCommand(sqlcommand, obj);
            Result = db.ExecuteNonQuery(dbcommand);
        }

        public void Delete(Quotation_local_charges Entity)
        {
            int Result = 0;
            ...
            Database db = DatabaseFactory.CreateDatabase("ApplicationServices");
            String sqlcommand = "[dbo].[quotation_local_charges.Delete]";
            DbCommand dbcommand = db.GetStoredProcCommand(sqlcommand, obj);
            Result = db.ExecuteNonQuery(dbcommand);
        }
    }
